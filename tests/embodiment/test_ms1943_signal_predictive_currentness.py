...
def test_recovery_after_empirical_signal_drift_does_not_reactivate_old_model_or_rewrite_coordination():
    ...
    try:
        ...
        # Recovery observations are explicitly assisted. The stale learned zero-row
        # proposal is no longer a lawful execution premise after the drift witness;
        # reuse the original supplied-row seed proposal that remains in the rehearsal registry.
        assisted = next(
