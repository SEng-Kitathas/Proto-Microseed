...
def test_ms_substrate_hardening_receipt_preserves_authority_ceiling_before_tag_readback():
    ...
    assert r['status'] in {'PROMOTION_CANDIDATE_SEALED__TAG_PUSH_READBACK_PENDING','CANONICAL_PROMOTION_SEALED__LOCAL_TAG_CREATED__REMOTE_PUSH_PENDING','CANONICAL_PROMOTION_SEALED','CANONICAL_PROMOTION_SEALED__REMOTE_TAG_AND_BRANCH_READBACK_CONFIRMED__PUBLIC_MAIN_UNMOVED','CANONICAL_PROMOTION_SEALED__PUBLIC_MAIN_FAST_FORWARD_RECONCILIATION_PENDING_FINAL_READBACK','CANONICAL_PROMOTION_SEALED__PUBLIC_MAIN_FAST_FORWARD_RECONCILIATION_CONFIRMED'}
