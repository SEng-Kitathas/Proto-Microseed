...
def test_current_composition_owner_inventory_remains_explicit_and_bounded():
    ...
    assert r['binding_now_embodied']=='YES_BOUNDED_B2_PLUS_DIRECT_B3_PLUS_BOUNDED_ARITY_2_TO_4_PLUS_FIXED_DEPTH_ONE_RECURSIVE_PLUS_B2_COMPATIBLE_RETROSPECTIVE_SEGMENT_REUSE'
    assert r['structural_segment_operand_scope']=='B2_COMPATIBLE_2_PLUS_2_RETROSPECTIVE_SIDES_ONLY'
    assert r['generic_structural_segment_operand']=='NOT_EARNED'
