...
def test_grouped_recursive_b2_does_not_count_as_direct_three_distinct_leaf_arity():
    r=run_audit()
    assert r['status']=='STOP_DISTINCT_LEAF_B3_ARITY_OWNER_MISSING'
    ...
    assert r['direct_b3_source_markers']==()
    assert r['localized_missing_mechanism']=='THREE_DISTINCT_CURRENT_GROUNDED_LEAF_OPERAND_CARRIER_AND_ORDERED_B3_OPERATOR'
