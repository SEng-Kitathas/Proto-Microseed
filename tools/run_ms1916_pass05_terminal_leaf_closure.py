...
BASE=ROOT/'reports'/'ms1916_pass05_full_suite_final'/'aggregate_receipt.json'
REPORT=ROOT/'reports'/'ms1916_pass05_terminal_leaf_closure'
...
for gid in terminal_groups:
    r=json.loads((ROOT/'reports'/'ms1916_pass05_full_suite_final'/gid/'receipt.json').read_text(encoding='utf-8'))
