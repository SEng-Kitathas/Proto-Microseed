...
def run_audit() -> dict[str,object]:
    ...
    return {
        ...
        'binding_now_embodied':'YES_BOUNDED_B2_PLUS_DIRECT_B3_PLUS_BOUNDED_ARITY_2_TO_4_PLUS_FIXED_DEPTH_ONE_SEGMENT_REUSE_PLUS_ONE_EXPLICIT_DEPTH_TWO_EDGE_PLUS_ONE_EXPLICIT_MIXED_DEPTH_THREE_EDGE_PLUS_ONE_EXPLICIT_MIXED_DEPTH_FOUR_EDGE_PLUS_ONE_EXPLICIT_MIXED_DEPTH_FIVE_EDGE',
        'structural_segment_operand_scope':'BOUNDED_DEPTH_ONE_TO_DEPTH_TWO_PLUS_MIXED_DEPTH_THREE_PLUS_MIXED_DEPTH_FOUR_PLUS_MIXED_DEPTH_FIVE_WITH_FULL_ANCESTRY_EXCLUSION',
        'generic_unbounded_structural_segment_operand':'NOT_EARNED',
        'recursive_depth':'5_FIXED_MIXED_EDGE_ONLY',
        ...
        'depth_five_reuse':'ONE_EXPLICIT_MIXED_DEPTH_EDGE_ONLY',
