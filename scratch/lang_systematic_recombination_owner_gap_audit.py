...
def run_audit() -> dict[str,object]:
    ...
    return {
        ...
        'binding_now_embodied':'YES_BOUNDED_B2_PLUS_DIRECT_B3_PLUS_BOUNDED_ARITY_2_TO_4_PLUS_FIXED_DEPTH_ONE_SEGMENT_REUSE_PLUS_ONE_EXPLICIT_DEPTH_TWO_EDGE_PLUS_ONE_EXPLICIT_MIXED_DEPTH_THREE_EDGE',
        'structural_segment_operand_scope':'BOUNDED_DEPTH_ONE_PARENTS_TO_DEPTH_TWO_PLUS_ONE_DEPTH_TWO_PARENT_WITH_ONE_EXTERNAL_DEPTH_ONE_PARENT_AT_EXPLICIT_DEPTH_THREE',
        'generic_unbounded_structural_segment_operand':'NOT_EARNED',
        'recursive_depth':'3_FIXED_MIXED_EDGE_ONLY',
